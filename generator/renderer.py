...
class ProjectRenderer:
    ...
    def _create_additional_directories(self) -> None:
        ...
        if self.choices["experiment_tracking"] != "none":
            directories.append("mlruns" if self.choices["experiment_tracking"] == "mlflow" else "wandb")
        
        if self.choices["orchestration"] != "none":
            directories.append("dags" if self.choices["orchestration"] == "airflow" else "pipelines")
