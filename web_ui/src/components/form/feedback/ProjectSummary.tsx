...
export function ProjectSummary({ values }: ProjectSummaryProps) {
  return (
    <div className="rounded-xl border border-border/70 bg-muted/15 p-5 animate-slide-in-up">
      <div className="flex items-center gap-3 mb-4 pb-3 border-b border-border/50">
        <div className="icon-chip icon-chip-cyan">
          <ListChecks className="w-4 h-4" />
        </div>
        <div>
          <p className="font-mono-label text-muted-foreground">Review</p>
          <h3 className="font-display text-base font-bold text-foreground">Configuration summary</h3>
        </div>
      </div>
        ...
        <div className="mt-4 pt-4 border-t border-border/50 space-y-2 font-mono text-sm">
          {values.project_name && (
            <div className="flex gap-3">
              <span className="text-muted-foreground w-16 shrink-0 font-mono-label">Project</span>
              <span className="font-semibold text-foreground truncate">{values.project_name}</span>
            </div>
          )}
          {values.author_name && (
            <div className="flex gap-3">
              <span className="text-muted-foreground w-16 shrink-0 font-mono-label">Author</span>
